...
@Service
public class GetExcelDownLoadManagerImpl implements GetExcelDownLoadManager {
	...
	private static Log log = LogFactory.getLog(GetExcelDownLoadManagerImpl.class.getName());
	private Connection jndiName = null;
	private String source;
	private String where;
	private String fileName = "";
	
	
	public GetExcelDownLoadManagerImpl() {
		super();
...
Connection conn = oracleDataSource.getConnection();
	...
	public String getFileName()
	{
		...
		try {
			if (fileName.equals(""))
			{
				...
				fileName = "DataElements" + "_" + excelFileSuffix + ".xls";
			}
		} catch (Exception e) {
	...
	private HSSFWorkbook generateExcelFile() throws Exception
	{
		Connection cn = null;
		Statement st = null;
		ResultSet rs = null;
