...
public class FormV2NewWrapper {
	...
	List<ProtocolNew> Protocol = new ArrayList<ProtocolNew>();
	...
	public List<ProtocolNew> getProtocol() {
		return Protocol;
	}

	@XmlElement(name = "protocol")
	public void setProtocol(List<ProtocolNew> protocol) {
		Protocol = protocol;
	}
