...
public class ModuleChangesWrapper {
	  private List newQuestions = null;
	  private List updatedQuestions = null;
	  private List deletedQuestions = null;
	  private ModuleTransferObject updatedModule = null;
	  private InstructionChangesTransferObject instructionChanges= null;
	  private String moduleId = null;
	  
	  public ModuleChangesWrapper()
	  {
	  }
	  ...
	  public InstructionChangesTransferObject getInstructionChanges()
	  {
	    return instructionChanges;
	  }

	  public void setInstructionChanges(InstructionChangesTransferObject instructionChanges)
	  {
	    this.instructionChanges = instructionChanges;
	  }

	  public ModuleTransferObject getUpdatedModule()
	  {
	    return updatedModule;
	  }

	  public void setUpdatedModule(ModuleTransferObject updatedModule)
	  {
