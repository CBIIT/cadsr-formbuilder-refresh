...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.searchChannel = exports.appChannel = undefined;
	...
	var appChannel = exports.appChannel = _backbone2.default.channel('appEvents');
	var searchChannel = exports.searchChannel = _backbone2.default.channel('search');
	...
	*/
	...
	(function (root, factory) {
	  ...
	  if (true) {
	    ...
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(30)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, Backbone) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppLayoutView = __webpack_require__(19);
	
	var _AppLayoutView2 = _interopRequireDefault(_AppLayoutView);
	...
	var App = Marionette.Application.extend({
		initialize: function initialize() {
			this.layout = new _AppLayoutView2.default();
			this.layout.render();
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchResultModel = __webpack_require__(16);
	
	var _SearchResultModel2 = _interopRequireDefault(_SearchResultModel);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var SearchResultsCollection = _backbone2.default.extend({
		model: _SearchResultModel2.default,
	...
	exports.default = SearchResultsCollection;
...
/***/ function(module, exports) {
	...
	var urlHelpers = {
		buildUrl: function buildUrl(baseUrl, data) {
			baseUrl = baseUrl + "?";
			function addParams(baseUrl, object) {
				for (var index in object) {
					var paramName = index;
					var paramValue = object[index];
					if (paramValue) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	_App2.default.on('start', function () {
		this.search = new _SearchService2.default({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchResultsModel = _backbone.Model.extend({
		defaults: {
	...
	exports.default = searchResultsModel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormSearchModel = _backbone.Model.extend({
		defaults: {
			formLongName: '',
			protocolIdSeq: '',
			protocolLongName: '',
	...
	exports.default = FormSearchModel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchResultModel = _backbone.Model.extend({
		defaults: {
	...
	exports.default = SearchResultModel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _radioChannels = __webpack_require__(4);
	...
	var SearchRouter = Backbone.Router.extend({
		...
		searchLayout: function searchLayout() {
			_radioChannels.searchChannel.request('set:searchLayout');
		} });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marionetteService = __webpack_require__(31);
	...
	var _SearchRouter = __webpack_require__(17);
	
	var _SearchRouter2 = _interopRequireDefault(_SearchRouter);
	
	var _SearchLayoutView = __webpack_require__(22);
	
	var _SearchLayoutView2 = _interopRequireDefault(_SearchLayoutView);
	
	var _SearchPreferencesModel = __webpack_require__(14);
	
	var _SearchPreferencesModel2 = _interopRequireDefault(_SearchPreferencesModel);
	
	var _FormSearchModel = __webpack_require__(15);
	
	var _FormSearchModel2 = _interopRequireDefault(_FormSearchModel);
	
	var _urlHelpers = __webpack_require__(12);
	
	var _urlHelpers2 = _interopRequireDefault(_urlHelpers);
	
	var _SearchResultsCollection = __webpack_require__(11);
	
	var _SearchResultsCollection2 = _interopRequireDefault(_SearchResultsCollection);
	...
	var SearchController = _marionetteService2.default.extend({
		radioRequests: {
		...
		initialize: function initialize() {
			...
			var searchRouter = new _SearchRouter2.default();
			this.container = options.container;
			/* use singleton instead if we want to persist the search results client side */
			this.searchResultsCollection = new _SearchResultsCollection2.default();
		...
		constructSearchLayout: function constructSearchLayout() {
			return new _SearchLayoutView2.default({
				searchPreferencesModel: _SearchPreferencesModel2.default,
				searchResultsCollection: this.searchResultsCollection,
				formSearchModel: this.formSearchModel
			});
		},
		dispatchSearchLayout: function dispatchSearchLayout() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HeaderView = __webpack_require__(21);
	
	var _HeaderView2 = _interopRequireDefault(_HeaderView);
	
	var _FooterView = __webpack_require__(20);
	
	var _FooterView2 = _interopRequireDefault(_FooterView);
	
	var _appLayout = __webpack_require__(34);
	...
	var AppLayoutView = _backbone2.default.LayoutView.extend({
		...
		initialize: function initialize() {
			...
			_radioChannels.appChannel.reply(_EVENTS2.default.APP.SET_MAIN_CONTENT_LAYOUT, function (contentView) {
				_this.showMainContent(contentView);
			});
		},
		...
		showFooter: function showFooter() {
			var footer = new _FooterView2.default();
			this.showChildView('footer', footer);
		},
		showMainContent: function showMainContent(contentView) {
			this.showChildView('main', contentView);
		}
	});
	
	exports.default = AppLayoutView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchLayout = __webpack_require__(38);
	
	var _searchLayout2 = _interopRequireDefault(_searchLayout);
	
	var _FormSearchView = __webpack_require__(23);
	
	var _FormSearchView2 = _interopRequireDefault(_FormSearchView);
	
	var _SearchResultsView = __webpack_require__(25);
	
	var _SearchResultsView2 = _interopRequireDefault(_SearchResultsView);
	
	var _SearchPreferencesView = __webpack_require__(24);
	
	var _SearchPreferencesView2 = _interopRequireDefault(_SearchPreferencesView);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var SearchLayoutView = _backbone2.default.LayoutView.extend({
		template: _searchLayout2.default,
		regions: {
		...
		initialize: function initialize(options) {
			...
			_radioChannels.searchChannel.reply(_EVENTS2.default.SEARCH.RESULTS_COLLECTION_RESET, function () {
				_this.showSearchResultsView(options.searchResultsCollection);
			});
		},
		...
		showFormSearchView: function showFormSearchView() {
			var view = new _FormSearchView2.default({
				model: this.formSearchModel
			});
			this.showChildView('searchCriteria', view);
		},
		showSearchResultsView: function showSearchResultsView(resultsCollection) {
			var view = new _SearchResultsView2.default({
				collection: resultsCollection
			});
			this.showChildView('searchResults', view);
		},
		showSearchPreferences: function showSearchPreferences() {
			var view = new _SearchPreferencesView2.default({
	...
	exports.default = SearchLayoutView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backbone2 = __webpack_require__(28);
	
	var _backbone3 = _interopRequireDefault(_backbone2);
	
	var _formSearch = __webpack_require__(37);
	...
	var FormSearchView = Marionette.ItemView.extend({
		template: _formSearch2.default,
		...
		gatherData: function gatherData(e) {
			e.preventDefault();
			this.dispatchFormData(_backbone3.default.serialize(this));
		},
		dispatchFormData: function dispatchFormData(data) {
			_radioChannels.searchChannel.request(_EVENTS2.default.SEARCH.SEND_SEARCH_INPUTS, data);
		}
	});
	
	exports.default = FormSearchView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchPreferences = __webpack_require__(39);
	
	var _searchPreferences2 = _interopRequireDefault(_searchPreferences);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }
	
	var SearchPreferencesView = Marionette.ItemView.extend({
		template: _searchPreferences2.default
	});
	
	exports.default = SearchPreferencesView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backgrid = __webpack_require__(9);
	
	var _backgrid2 = _interopRequireDefault(_backgrid);
	
	var _backgridSelectAll = __webpack_require__(29);
	
	var _backgridSelectAll2 = _interopRequireDefault(_backgridSelectAll);
	...
	*/
	...
	var SearchResultsView = _backgrid2.default.Grid.extend({
		columns: [{
		...
		onAttach: function onAttach() {
			var totalResults = this.collection.length;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(2), __webpack_require__(6)], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, Backbone, $) {
	...
	*/
	(function (root, factory) {
	  if (true) {
	    ...
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(9), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else if (typeof exports == "object") {
	    // CommonJS
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(global, factory) {
	  'use strict';
	  if(true) {
	    module.exports = factory(__webpack_require__(33), __webpack_require__(7), __webpack_require__(1)); //jshint ignore:line
	  } else if(typeof define === 'function' && define.amd) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(_, module) {module.exports = function(obj){
	var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
	with(obj||{}){
	__p+='<div class="search-preferences">\n	<p>Search Preferences</p>\n</div>\n<form class="search-form">\n	<div class="search-criteria">\n		<h3>Search For Forms</h3>\n		<p>Note: Enter/select search criteria and click search button to initiate search. The wildcard character is *. For additional information on how to use Form Builder, click the Help button above.</p>\n		<div class="form-control">\n			<label for="">Form Long Name</label> <input name="formLongName" type="text" value="'+
	((__t=( formLongName ))==null?'':_.escape(__t))+
	'"/>\n		</div>\n		<div class="form-control">\n			<label for="">Public ID</label> <input name="publicId" type="text" value="'+
	((__t=( publicId ))==null?'':_.escape(__t))+
	'"/>\n		</div>\n		<div class="form-control">\n			<label for="">Protocol Long Name</label> <input name="protocolLongName" type="text" value="'+
	((__t=( protocolLongName ))==null?'':_.escape(__t))+
	'"/>\n		</div>\n		<div class="form-control">\n			<label for="">CS/CSI (Classification)</label> <input name="classification" type="text" value="'+
	((__t=( classification ))==null?'':_.escape(__t))+
	'"/>\n		</div>\n		<div class="form-control">\n			<label for="">CDE Public ID</label> <input type="text" name="cdePublicId"  value="'+
	((__t=( cdePublicId ))==null?'':_.escape(__t))+
	'"/>\n		</div>\n\n		<div class="form-control">\n			<label for="">Module</label> <input type="text" name="module"  value="'+
	((__t=( module ))==null?'':_.escape(__t))+
	'"/>\n		</div>\n		<div class="form-control">\n			<label for="">Workflow</label> <select>\n			<option value=""></option>\n		</select>\n		</div>\n		<div class="form-control">\n			<label for="">Context</label> <select>\n			<option value=""></option>\n		</select>\n		</div>\n		<div class="form-control">\n			<label for="">Category</label> <select>\n			<option value=""></option>\n		</select>\n		</div>\n		<div class="form-control">\n			<label for="">Type</label> <select>\n			<option value=""></option>\n		</select>\n		</div>\n	</div>\n	<div class="button-group">\n		<input type="submit" id="search-button" value="Submit" />\n	</div>\n</form>\n';
	}
	return __p;
	};
...
/***/ function(module, exports) {
	...
	var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
	with(obj||{}){
	__p+='<div class="search-preferences">\n\n</div>\n<div id="search-form-wrapper">\n	<p>Search form wrapper</p>\n	<div class="results-table">\n\n	</div>\n	<div class="paginator">\n\n	</div>\n</div>\n<div id="search-results-wrapper">\n	<p>Search results wrapper</p>\n</div>';
	}
	return __p;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
	with(obj||{}){
	__p+='<div id="search-form-wrapper">\n	<div class="search-preferences">\n	</div>\n	<form class="search-preferences-form">\n		<div class="form-group">\n			<label for="">Exclude "Test" Context</label>\n			<input type="checkbox" name="'+
	((__t=( excludeTestContext ))==null?'':_.escape(__t))+
	'" />\n		</div>\n		<div class="form-group">\n			<label for="">Exclude "Training" Context</label>\n			<input type="checkbox" name="'+
	((__t=( excludeTrainingContext ))==null?'':_.escape(__t))+
...
/***/ function(module, exports, __webpack_require__, __webpack_module_template_argument_0__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(1), __webpack_require__(8), (__webpack_require__(__webpack_module_template_argument_0__))], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
